...
def main():
    ...
    with demographics:
        ...
        with st.form("demographic_form"):
            ...
            familiarity = st.selectbox("Familiarity", [
    ...
    with tasks:
        ...
        if start_button:
            ...
            st.info("Timer started! Begin the task now.")
        ...
        if st.button("Save Task Results"):
            ...
            st.success("Task saved successfully! Please proceed to the Exit Questionnaire tab.")
    ...
    with exit:
        ...
        with st.form("exit_form"):
            satisfaction = st.select_slider(
                "Overall Satisfaction (1 = Very Low, 5 = Very High)",
                options=[1, 2, 3, 4, 5],
                format_func=lambda x: ["Very Dissatisfied", "Dissatisfied", "Neutral", "Satisfied", "Very Satisfied"][
                    x - 1],
                value=3
            )
            ...
            if submitted_exit:
                ...
                st.success("Exit Questionnaire saved successfully! Please proceed to the Report tab.")
